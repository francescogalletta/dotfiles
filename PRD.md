...
| Window mgmt | AeroSpace (tiling WM) + JankyBorders (focus highlight, sage `#a3b18a` on crust `#11111b`, 4px, 6px gaps — ADR-040), config in `config/aerospace/` (ADR-033); resize is modeless, only `service` remains a binding mode (ADR-039) |
